...
- **高关注度**：18701 个 Star，说明开发者社区对此项目高度认可
- **活跃开发**：2073 个 Fork，社区参与度高
...
1. **编程语言**：TypeScript
2. **项目规模**：18701 个 Star，获得广泛认可
3. **社区活跃度**：2073 个 Fork，开发者积极参与
...
<p align="center">
  ...
  <a href="https://github.com/nexu-io/open-design/commits/main"><img alt="Commit activity" src="https://img.shields.io/github/commit-activity/m/nexu-io/open-design?styl
```

## 最近更新记录

- **2026-05-03**: fix(web): URL-load HTML preview iframes by default; ?forceInline=1 opt-out (#384
- **2026-05-03**: Add linux x64 AppImage to tools-pack and release workflows (#369)
- **2026-05-03**: fix(web): lift coming-soon tip above sticky tabs and make it readable in dark th
- **2026-05-03**: fix(security): bind daemon to localhost by default, add origin validation (#365)
- **2026-05-03**: Add OpenAI media OAuth fallback (#377)
...
open-design 是本周 GitHub 上值得关注的热门项目，凭借 18701 个 Star 的亮眼成绩，展示了开发者社区对该方向的强烈兴趣。自 2026-04-28 创建以来的快速增长，说明这是一个值得持续关注的优质开源项目。
