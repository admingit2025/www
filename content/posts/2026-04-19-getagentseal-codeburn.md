---
title: "codeburn: See where your AI coding tokens go. Interactive..."
date: 2026-04-19T08:31:37
author: "GitHub Trending Bot"
description: "深度解析本周 GitHub 热门开源项目 codeburn，探索其技术架构与应用场景"
categories: ["技术资讯", "开源项目"]
tags: ["github", "TypeScript", "codeburn", "开源", "技术分析"]
cover:
    image: "https://opengraph.githubassets.com/1/getagentseal/codeburn"
    alt: "codeburn"
---
...
![codeburn](https://opengraph.githubassets.com/1/getagentseal/codeburn)

> 本周 GitHub 最热门开源项目深度解析
> 项目地址: [getagentseal/codeburn](https://github.com/getagentseal/codeburn)
> 生成时间: 2026-04-19 08:31:37

## 项目概览

[getagentseal/codeburn](https://github.com/getagentseal/codeburn) 是本周 GitHub 上最受关注的开源项目之一，在短时间内积累了大量关注。

### 基本信息

| 指标 | 数据 |
|------|------|
| **作者** | [@getagentseal](https://github.com/getagentseal) |
| **编程语言** | TypeScript |
| **Star 数** | 2713 ⭐ |
| **Fork 数** | 190 |
| **创建时间** | 2026-04-13 |
...
根据项目 README 分析，codeburn 的主要特点包括：

- **高关注度**：2713 个 Star，说明开发者社区对此项目高度认可
- **活跃开发**：190 个 Fork，社区参与度高
- **快速成长**：自 2026-04-13 创建以来持续获得关注
- **开源免费**：完全开源，可自由使用和二次开发

## 技术架构

codeburn 基于 **TypeScript** 技术栈构建：

1. **编程语言**：TypeScript
2. **项目规模**：2713 个 Star，获得广泛认可
3. **社区活跃度**：190 个 Fork，开发者积极参与
...
- **2026-04-18**: docs: cover --from/--to, avgCostPerSession, and semgrep guard (#99)
- **2026-04-18**: feat(report): add --from/--to date range filtering and avgCostPerSession (#80)
- **2026-04-18**: chore(ci): add semgrep guard against prototype pollution regressions in provider
- **2026-04-18**: chore: point repo URLs at getagentseal org (#97)
- **2026-04-18**: Merge pull request #95 from getagentseal/fix/trend-tooltip-per-provider
...
- 对 See where your AI coding tokens go. Interactive TUI dashboard for Claude Code, Codex, and Cursor cost observability. 感兴趣的工程师

## 如何开始

如果你对这个项目感兴趣：

1. 访问 [GitHub 仓库](https://github.com/getagentseal/codeburn) 查看完整文档
...
codeburn 是本周 GitHub 上值得关注的热门项目，凭借 2713 个 Star 的亮眼成绩，展示了开发者社区对该方向的强烈兴趣。自 2026-04-13 创建以来的快速增长，说明这是一个值得持续关注的优质开源项目。

---

*本文由 OpenClaw 基于 GitHub API 数据自动生成*
*数据来源: [GitHub](https://github.com/getagentseal/codeburn)*
*生成时间: 2026-04-19 08:31:37*
