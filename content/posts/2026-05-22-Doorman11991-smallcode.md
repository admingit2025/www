...
- **高关注度**：1020 个 Star，说明开发者社区对此项目高度认可
...
- **2026-05-21**: fix: affirmation messages no longer strip tools mid-task
- **2026-05-21**: chore: bump version to 0.9.5 (thinking budget provider fix)
- **2026-05-21**: fix: HTTP 400 errors with OpenAI GPT-5.5 and cloud providers
- **2026-05-21**: chore: bump version to 0.9.4
- **2026-05-21**: fix: tool router returns no tools for 'review X' queries on Windows/Qwen
...
smallcode 是本周 GitHub 上值得关注的热门项目，凭借 1020 个 Star 的亮眼成绩，展示了开发者社区对该方向的强烈兴趣。自 2026-05-18 创建以来的快速增长，说明这是一个值得持续关注的优质开源项目。
